...
`sksecurity` community a harassment-free experience for everyone, regardless of age,
...
Because `sksecurity` is **security software** — and the ecosystem's honest-claim
auditor — positive conduct here also means:

- **Intellectual honesty about security claims.** We hold ourselves to the rule we
  enforce on others: say "quantum-resistant" / "post-quantum," never "quantum-proof,"
  "quantum-safe," or "unbreakable"; never imply AES-256 is quantum-broken; cite
  evidence (surface + FIPS number + hybrid-vs-classical).
- **Responsible disclosure.** Report vulnerabilities privately per
  [SECURITY.md](SECURITY.md), never as a public "gotcha." Do not weaponize a finding to
  shame a contributor.
- **No weakening of defenses for convenience.** Don't disable the secret guard or a
  scanner check to make a PR pass; fix the underlying issue.
...
- Publishing others' private information, such as a physical or email address, or
  credentials/secrets, without their explicit permission
- Knowingly misrepresenting a security property, or publicly disclosing an unfixed
  vulnerability to pressure or shame contributors
...
maintainer contact listed on the [`smilinTux/sksecurity`](https://github.com/smilinTux/sksecurity)
...
Code of Conduct, for a specified period of time. Violating these terms may lead to a
